...
You can download the latest installer from the Releases page.
    ...
    Download the DimScreen-Setup.exe file from the latest release.
    Run the installer and follow the on-screen instructions.
    A shortcut will be created on your desktop.

How to Use

    Launch the DimScreen app from your desktop shortcut.
    Use the slider to adjust the brightness.
    Click "Reset" to turn the dimming off.
    Click "Send to Tray" to hide the controller window. Reopen it by right-clicking the icon in your system tray.
    Click "Force Stop" to close the application completely.
